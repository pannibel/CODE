...
const clues = [
    ...
    {
        id: 29,
        text: 'OH NO! WHILE YOU WERE BUSY INVESTIGATING, THE KILLER HAD THEIR EYES ON YOU AND NOW THEY GOT A CHANCE TO STOP YOU BEFORE YOU REVEAL EVERY DETAIL OF THE MURDER. IN OTHER WORDS, THEY KILLED YOU TOO. IF YOU WANT TO START OVER, YOU HAVE TO COLLECT EVERY EVIDENCE AGAIN.',
        options: [
            {
                text: 'START OVER',
